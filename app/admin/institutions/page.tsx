                ...
                <div className="max-w-7xl mx-auto px-6 py-8">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Manage educational institutions and their settings</p>
                        </div>
                        <Link
                            href="/admin/institutions/create"
                            className="flex items-center gap-2 px-6 py-3 bg-gray-900 text-white font-semibold hover:bg-orange-600 transition-colors shadow-sm"
                        >
            ...
            <div className="max-w-7xl mx-auto px-6 py-6">
                ...
                <div className="relative mb-6">
                    ...
                    <input
                        ...
                        className="w-full pl-12 pr-4 py-3 bg-white border border-gray-200 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all text-sm"
                    />
                </div>
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="bg-gray-50 border-b border-gray-200">
                                    <th className="px-6 py-4 text-xs font-semibold text-gray-600 uppercase tracking-wider">Institution</th>
                                    <th className="px-6 py-4 text-xs font-semibold text-gray-600 uppercase tracking-wider">Domain</th>
                                    <th className="px-6 py-4 text-xs font-semibold text-gray-600 uppercase tracking-wider text-center">Users</th>
                                    <th className="px-6 py-4 text-xs font-semibold text-gray-600 uppercase tracking-wider text-center">Batches</th>
                                    <th className="px-6 py-4 text-xs font-semibold text-gray-600 uppercase tracking-wider">Manager</th>
                                    ...
                                    filteredInstitutions.map((inst) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4 text-center">
                                                <span className="text-sm font-semibold text-gray-900">{inst._count.users}</span>
                                            </td>
                                            <td className="px-6 py-4 text-center">
                                                <span className="text-sm font-semibold text-gray-900">{inst._count.classrooms}</span>
                                            </td>
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-2">
                                                    <div className="w-8 h-8 bg-orange-100 rounded flex items-center justify-center text-orange-600 text-xs font-semibold">
                                                        {inst.managerName.charAt(0).toUpperCase()}
                                                    </div>
                                                    <span className="text-sm text-gray-700">{inst.managerName}</span>
                                                </div>
                                            </td>
