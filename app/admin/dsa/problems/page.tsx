        ...
        <div className="min-h-screen pt-24 pb-12 px-6 bg-white">
            <div className="max-w-6xl mx-auto ml-0">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900 mb-2">DSA Practice Problems</h1>
                        <p className="text-gray-500">Create, edit, and manage DSA coding challenges.</p>
                    </div>
                    <Link
                        href="/admin/dsa/problems/create"
