...
export default function ProblemsSelectionPage() {
  const handleSqlClick = (e: React.MouseEvent) => {
    e.preventDefault();
    toast.info("SQL Problems Coming Soon!", {
      description: "We are working hard to bring you SQL content. Stay tuned!",
    });
  };
    ...
    <div className="min-h-screen bg-white py-8 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          {/* SQL Card */}
          <div onClick={handleSqlClick} className="w-full">
            <motion.div
              whileHover={{ y: -4 }}
              whileTap={{ scale: 0.99 }}
              className="relative overflow-hidden rounded-xl h-80 w-full cursor-pointer group shadow-lg border border-gray-200 bg-gray-50"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-gray-100 to-white opacity-100" />
              ...
              <div className="absolute right-0 bottom-0 opacity-5">
                <svg width="200" height="200" viewBox="0 0 200 200">
                  ...
                  <path d="M20 100 H180" stroke="black" strokeWidth="2" />
                  <path d="M100 20 V180" stroke="black" strokeWidth="2" />
                </svg>
              </div>

              <div className="relative h-full flex flex-col justify-between p-8 z-10">
                <div className="flex justify-between items-start">
                  <div className="w-16 h-16 bg-white shadow-sm border border-gray-200 rounded-lg flex items-center justify-center group-hover:scale-105 transition-transform duration-300">
                    <svg className="w-8 h-8 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4m0 5c0 2.21-3.582 4-8 4s-8-1.79-8-4" />
                    </svg>
                  </div>
                  <span className="bg-orange-100 text-orange-600 text-xs font-bold px-3 py-1 rounded-full border border-orange-200 uppercase tracking-wider">Coming Soon</span>
                </div>

                <div className="text-left">
                  <h2 className="text-4xl font-bold text-gray-800 mb-2 tracking-tight">SQL</h2>
                  <p className="text-gray-500 font-medium text-lg mb-6">Deep dive into Database Management and Queries.</p>
                  <div className="inline-flex items-center gap-2 text-gray-400 font-semibold cursor-not-allowed">
