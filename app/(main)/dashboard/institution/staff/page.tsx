...
function StaffManagementContent() {
  ...
  if (
    !session ||
    !["INSTITUTION_MANAGER", "ADMIN"].includes((session.user as any).role)
  ) {
    return (
      ...
      <div className="min-h-screen flex flex-col items-center justify-center text-gray-500 gap-4">
        ...
        <div className="text-center md:max-w-md px-6">
          ...
          <p className="mt-2 text-sm">
            Your account is not associated with any institution. Please contact
            an administrator to be assigned to your organization.
          </p>
        </div>
      </div>
    );
      ...
      <div className="max-w-6xl mx-auto ml-0">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10">
          <div>
            ...
            <p className="text-gray-500 mt-1 font-medium italic">
              Manage roles and access for your institution's team.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-4">
                ...
                <div className="text-xs font-bold text-gray-400 uppercase tracking-widest">
                  Showing {filteredStaff.length} Result
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="p-4 bg-orange-50 rounded-2xl border border-orange-100/50">
                  ...
                  <div className="text-lg font-black text-orange-900">
                    {(session.user as any).institution?.name || "Loading..."}
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="p-3 bg-gray-50 rounded-xl text-center">
                    ...
                    <div className="text-xl font-black text-gray-900">
                      {staff.filter((s) => s.role === "CONTEST_MANAGER").length}
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-linear-to-br from-indigo-600 to-blue-700 rounded-3xl p-6 text-white shadow-2xl shadow-blue-200 relative overflow-hidden group">
