...
async function DashboardData() {
    ...
    if (!["INSTITUTION_MANAGER", "ADMIN"].includes(currentUser.role)) {
        return (
            <div className="min-h-screen flex items-center justify-center text-gray-500 dark:text-gray-400 text-center px-6 bg-white dark:bg-[#24262C]">
    ...
    if (!institutionId) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center text-gray-500 dark:text-gray-400 gap-4 bg-white dark:bg-[#24262C]">
...
export default function InstitutionDashboard() {
    return (
        <Suspense fallback={
            <div className="min-h-screen pt-24 pb-12 px-6 bg-white dark:bg-[#24262C] flex items-center justify-center">
