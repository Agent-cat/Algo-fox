...
export default function ManagersPage() {
    ...
    const fetchData = async () => {
        ...
        setIsLoading(true);
        const res = await getInstitutionUsers(institutionId, "CONTEST_MANAGER", currentPage);
    ...
    return (
        <div className="p-8 max-w-7xl mx-auto space-y-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-black text-gray-900 dark:text-white tracking-tight">Contest Managers</h1>
                    <p className="text-gray-500 dark:text-gray-400 mt-2">Staff responsible for organizing and overseeing contests.</p>
                </div>
                <Link
