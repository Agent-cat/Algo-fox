...
export default function ProblemsList({ allocatedDomains }: { allocatedDomains: ProblemDomain[] }) {
  ...
  const displayedCourses = courses.filter(course => allocatedDomains.includes(course.domain));
