    ...
    return (
        <div className="min-h-screen pt-24 pb-12 px-6 bg-white dark:bg-slate-950">
            <div className="max-w-3xl mx-auto ml-0">
                ...
                <div className="mb-8">
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Create New SQL Problem</h1>
                    <p className="text-gray-500 dark:text-gray-400">Add a new SQL challenge for the community.</p>
                </div>
