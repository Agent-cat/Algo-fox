...
import { Building2, Save, ArrowLeft, Globe, Shield, Sparkles, Layout, ArrowRight, Loader2, Plus, School } from "lucide-react";
            ...
            <div className="pt-24 pb-16 px-6 relative overflow-hidden">
                <div className="max-w-3xl mx-auto flex flex-col items-center text-center">
                    ...
                    <p className="text-gray-500 font-medium text-lg max-w-xl mb-12">
                        Register a new institution to the global network hub and delegate administrative authority.
                    </p>
            ...
            <div className="max-w-3xl mx-auto px-6 -mt-10 relative z-10">
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-16">
                        ...
                        <div className="space-y-10">
                            <div className="flex items-center gap-3 mb-10 border-b border-gray-50 pb-6">
                                ...
                                <h3 className="text-[11px] font-black text-gray-900 uppercase tracking-[0.4em]">Core Credentials</h3>
                            </div>

                            <div className="grid gap-10">
                                <div className="space-y-4">
                                    <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest pl-2">Formal Institution Name</label>
                                    <input
                                        {...form.register("name")}
                                        onChange={(e) => {
                                        ...
                                        className="w-full px-8 py-6 bg-[#FAFAFA] border border-gray-100 rounded-[2.5rem] text-sm font-bold focus:bg-white focus:outline-none focus:ring-[12px] focus:ring-orange-500/5 focus:border-orange-500 transition-all shadow-inner"
                                        placeholder="e.g. Stanford University"
                                    />
                                    {form.formState.errors.name && (
                                        <p className="text-[10px] font-bold text-red-600 uppercase tracking-widest mt-2 px-2">{form.formState.errors.name.message}</p>
                                    )}
                                </div>

                                <div className="space-y-4">
                                    <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest pl-2">Unique Access Slug</label>
                                    <input
                                        {...form.register("slug")}
                                        className="w-full px-8 py-6 bg-[#FAFAFA] border border-gray-100 rounded-[2.5rem] text-sm font-bold focus:bg-white focus:outline-none focus:ring-[12px] focus:ring-orange-500/5 focus:border-orange-500 transition-all shadow-inner tracking-widest font-mono"
                                        placeholder="stanford-active"
                                    />
                                    {form.formState.errors.slug && (
                                        <p className="text-[10px] font-bold text-red-600 uppercase tracking-widest mt-2 px-2">{form.formState.errors.slug.message}</p>
                                    )}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-10">
                            <div className="flex items-center gap-3 mb-10 border-b border-gray-50 pb-6">
                                ...
                                <h3 className="text-[11px] font-black text-gray-900 uppercase tracking-[0.4em]">Network Routing</h3>
                            </div>

                            <div className="grid md:grid-cols-2 gap-10">
                                <div className="space-y-4">
                                    <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest pl-2">Institution Domain</label>
                                    <input
                                        {...form.register("domain")}
                                        className="w-full px-8 py-6 bg-[#FAFAFA] border border-gray-100 rounded-[2.5rem] text-sm font-bold focus:bg-white focus:outline-none focus:ring-[12px] focus:ring-orange-500/5 focus:border-orange-500 transition-all shadow-inner lowercase"
                                        placeholder="stanford.edu"
                                    />
                                </div>
                                <div className="space-y-4">
                                    <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest pl-2">Logo URL (Icon)</label>
                                    <input
                                        {...form.register("logo")}
                                        className="w-full px-8 py-6 bg-[#FAFAFA] border border-gray-100 rounded-[2.5rem] text-sm font-bold focus:bg-white focus:outline-none focus:ring-[12px] focus:ring-orange-500/5 focus:border-orange-500 transition-all shadow-inner"
                ...
                <div className="mt-20 flex flex-col items-center gap-6 opacity-40">
                    ...
                    <div className="inline-flex items-center gap-3 px-8 py-4 bg-white rounded-full border border-gray-100 shadow-sm">
                        ...
                        <span className="text-[9px] font-black text-gray-400 uppercase tracking-[0.4em]">Secure Node Initialization Protocol Verified</span>
                    </div>
                </div>
            </div>
        </div>
