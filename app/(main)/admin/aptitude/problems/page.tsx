...
export default function AptitudeAdminProblemsPage() {
    ...
    const fetchProblems = async () => {
        setIsLoading(true);
        try {
            const res = await getAdminProblems(1, 100, "APTITUDE", "CONCEPT", "LEARN");
    ...
    return (
        <div className="min-h-screen pt-4">
            <AdminListPage
                ...
                subtitle="Create, edit, and manage MCQ-style aptitude questions."
                createLink="/admin/aptitude/problems/create"
