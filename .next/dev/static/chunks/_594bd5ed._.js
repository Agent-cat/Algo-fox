...
"[project]/actions/data:3e2b00 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$3e2b00__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/actions/data:3e2b00 [app-client] (ecmascript) <text/javascript>");
...
function BasicInfoSettings({ user }) {
    ...
    const onSubmit = async (data)=>{
        ...
        try {
            ...
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$3e2b00__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["updateUserInfo"])({
                name: fullName,
                bio: data.bio
            });
            if (res.success) {
...
//# sourceMappingURL=_594bd5ed._.js.map