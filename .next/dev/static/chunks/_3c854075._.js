...
"[project]/components/DevToolsBlocker.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DevToolsBlocker.useEffect": ()=>{
            ...
            const handleContextMenu = {
                "DevToolsBlocker.useEffect.handleContextMenu": (e)=>{
                    e.preventDefault();
                    e.stopPropagation();
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Right-click is disabled.");
                    return false;
                }
            }["DevToolsBlocker.useEffect.handleContextMenu"];
            ...
            const handleKeyDown = {
                "DevToolsBlocker.useEffect.handleKeyDown": (e)=>{
                    ...
                    const blockAction = {
                        "DevToolsBlocker.useEffect.handleKeyDown.blockAction": (actionName)=>{
                            e.preventDefault();
                            e.stopPropagation();
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(`${actionName} is disabled.`);
                            return false;
                        }
                    }["DevToolsBlocker.useEffect.handleKeyDown.blockAction"];
            ...
            const handleCopyCutPaste = {
                "DevToolsBlocker.useEffect.handleCopyCutPaste": (e)=>{
                    ...
                    e.preventDefault();
                    e.stopPropagation();
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Copying and pasting is disabled in this application.");
                    return false;
                }
            }["DevToolsBlocker.useEffect.handleCopyCutPaste"];
            // 4. Disable Text Selection (Fallback for CSS user-select: none)
            const handleSelectStart = {
                "DevToolsBlocker.useEffect.handleSelectStart": (e)=>{
            ...
            }["DevToolsBlocker.useEffect.handleSelectStart"];
            // 5. DevTools Detection via Console
            let devtools = false;
            const element = new Image();
            const detectDevTools = {
                "DevToolsBlocker.useEffect.detectDevTools": ()=>{
                    if (devtools) {
                        console.clear();
                        ...
                        }["DevToolsBlocker.useEffect.detectDevTools"], 1000);
                    }
                }
            }["DevToolsBlocker.useEffect.detectDevTools"];
            Object.defineProperty(element, 'id', {
                get: {
                    "DevToolsBlocker.useEffect": function() {
                        devtools = true;
                        detectDevTools();
                        return "id";
                    }
            ...
            const checkDevToolsResize = {
                "DevToolsBlocker.useEffect.checkDevToolsResize": ()=>{
            ...
            const consoleDetectionInterval = setInterval({
                "DevToolsBlocker.useEffect.consoleDetectionInterval": ()=>{
                    devtools = false;
                    console.log(element);
                    console.clear();
                }
            }["DevToolsBlocker.useEffect.consoleDetectionInterval"], 1000);
            const checkResizeInterval = setInterval(checkDevToolsResize, 500);
            // 7. Aggressive Debugger Loop
            const runDebugger = setInterval({
                "DevToolsBlocker.useEffect.runDebugger": ()=>{
                    ({
                        "DevToolsBlocker.useEffect.runDebugger": function() {
                            // @ts-ignore
                            debugger;
                        }
                    })["DevToolsBlocker.useEffect.runDebugger"]();
                }
            }["DevToolsBlocker.useEffect.runDebugger"], 100);
            let debuggerTimeoutId;
            const debuggerLoop = {
                "DevToolsBlocker.useEffect.debuggerLoop": ()=>{
                    // @ts-ignore
                    debugger;
...
_s(DevToolsBlocker, "BVvivrSRe8/FL3eVGyG/GYgr2vQ=", false, function() {
    return [
...
//# sourceMappingURL=_3c854075._.js.map