...
"[project]/components/settings/BasicInfoSettings.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function BasicInfoSettings({ user }) {
    ...
    const onSubmit = async (data)=>{
        ...
        try {
            ...
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$196d55__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["updateUserInfo"])({
                name: fullName,
                bio: data.bio
            });
            if (res.success) {
...
//# sourceMappingURL=_f1e76bd7._.js.map