...
function PlatformSettings({ user }) {
    ...
    const { register, handleSubmit, getValues, setValue, watch, formState: { errors } } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hook$2d$form$2f$dist$2f$index$2e$esm$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useForm"])({
        defaultValues: {
    ...
    const onSubmit = async (platform)=>{
        ...
        // Prepare data for update (only include what's supported by backend)
        // We currently only support leetCode, codeChef, codeforces, github in the main update action
        // If we want to support others, we need to update the backend action and schema.
        try {
            const updatePayload = {
            ...
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$572fcd__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["updateUserInfo"])(updatePayload);
            if (res.success) {
    ...
    const PlatformRow = ({ id, label, iconSrc, placeholder, prefix, urlPrefix })=>{
        const value = watch(id);
        const isConnected = !!value; // simplified check
...
//# sourceMappingURL=_6b5e05ce._.js.map