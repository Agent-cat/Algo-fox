...
function __TURBOPACK__default__export__(locale) {
    ...
    function newFormat(specifier, options) {
        ...
        var prefix = (options?.prefix !== undefined ? options.prefix : "") + (symbol === "$" ? currencyPrefix : symbol === "#" && /[boxX]/.test(type) ? "0" + type.toLowerCase() : ""), suffix = (symbol === "$" ? currencySuffix : /[%p]/.test(type) ? percent : "") + (options?.suffix !== undefined ? options.suffix : "");
...
//# sourceMappingURL=node_modules_b6956948._.js.map