module.exports = [
"[project]/node_modules/msgpackr/unpack.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/msgpackr/pack.js [app-route] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$msgpackr$2f$unpack$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/msgpackr/unpack.js [app-route] (ecmascript)");
;
let textEncoder;
try {
...
class Packr extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$msgpackr$2f$unpack$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Unpackr"] {
    constructor(options){
        super(options);
        this.offset = 0;
        let typeBuffer;
            ...
            if (type === 'string') {
                ...
                if (value >>> 0 === value) {
                    ...
                    if ((useFloat32 = this.useFloat32) > 0 && value < 0x100000000 && value >= -0x80000000) {
                        ...
                        (xShifted = value * __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$msgpackr$2f$unpack$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["mult10"][(target[position] & 0x7f) << 1 | target[position + 1] >> 7]) >> 0 === xShifted) {
                            position += 4;
                            return;
...
extensionClasses = [
    ...
    DataView,
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$msgpackr$2f$unpack$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["C1Type"]
];
extensions = [
    {
    ...
    },
    {
        pack (typedArray, allocateForWrite) {
            ...
            if (constructor !== ByteArray && this.moreTypes) writeExtBuffer(typedArray, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$msgpackr$2f$unpack$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["typedArrays"].indexOf(constructor.name), allocateForWrite);
...
function addExtension(extension) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$msgpackr$2f$unpack$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addExtension"])(extension);
}
...
;
;
const { NEVER, ALWAYS, DECIMAL_ROUND, DECIMAL_FIT } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$msgpackr$2f$unpack$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FLOAT32_OPTIONS"];
const REUSE_BUFFER_MODE = 512;
const RESET_BUFFER_MODE = 1024;
const RESERVE_START_SPACE = 2048;
}),
"[project]/node_modules/msgpackr/struct.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$msgpackr$2f$pack$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["setWriteStructSlots"])(writeStruct, prepareStructures);
function writeStruct(object, target, encodingStart, position, structures, makeRoom, pack, packr) {
                ...
                if (nextId < 200 || !nextTransition.num64) {
                    if (number >> 0 === number && number < 0x20000000 && number > -0x1f000000) {
                        ...
                        if (float32Headers[target[position + 3] >>> 5]) {
                            ...
                            if ((xShifted = number * __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$msgpackr$2f$unpack$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["mult10"][(target[position + 3] & 0x7f) << 1 | target[position + 2] >> 7]) >> 0 === xShifted) {
                                transition = nextTransition.num32 || createTypeTransition(nextTransition, NUMBER, 4);
                                position += 4;
                                break;
                            }
    ...
    let recordId = transition[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$msgpackr$2f$pack$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["RECORD_SYMBOL"]];
    if (recordId == null) {
        ...
        structure.reverse();
        transition[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$msgpackr$2f$pack$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["RECORD_SYMBOL"]] = recordId;
...
function onLoadedStructures(sharedData) {
    ...
    for(let i = 0, l = typed.length; i < l; i++){
        ...
        transition[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$msgpackr$2f$pack$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["RECORD_SYMBOL"]] = i;
    }
            ...
            switch(type){
                case ASCII:
                    ...
                    get = function(source) {
						...
						}*/ return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$msgpackr$2f$unpack$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readString"])(src, ref + refStart, end - ref);
                    ...
                    switch(size){
                        case 4:
                            get = function(source) {
                                ...
                                // this does rounding of numbers that were encoded in 32-bit float to nearest significant decimal digit that could be preserved
                                let multiplier = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$msgpackr$2f$unpack$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["mult10"][(src[position + 3] & 0x7f) << 1 | src[position + 2] >> 7];
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$msgpackr$2f$unpack$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["setReadStruct"])(readStruct, onLoadedStructures, saveState);
}),
"[project]/node_modules/msgpackr/stream.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class PackrStream extends __TURBOPACK__imported__module__$5b$externals$5d2f$stream__$5b$external$5d$__$28$stream$2c$__cjs$29$__["Transform"] {
    constructor(options){
        ...
        this.packr = options.packr || new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$msgpackr$2f$pack$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Packr"](options);
    }
...
class UnpackrStream extends __TURBOPACK__imported__module__$5b$externals$5d2f$stream__$5b$external$5d$__$28$stream$2c$__cjs$29$__["Transform"] {
    constructor(options){
        ...
        super(options);
        options.structures = [];
        this.unpackr = options.unpackr || new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$msgpackr$2f$unpack$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Unpackr"](options);
    }
...
"[project]/node_modules/msgpackr/iterators.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function* packIterSync(objectIterator, options) {
    const packr = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$msgpackr$2f$pack$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Packr"](options);
...
function unpackIter(bufferIterator, options = {}) {
    ...
    const unpackr = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$msgpackr$2f$unpack$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Unpackr"](options);
    let incomplete;
    const parser = (chunk)=>{
        let yields;
...
"[project]/node_modules/msgpackr/node-index.js [app-route] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$msgpackr$2f$pack$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/msgpackr/pack.js [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$msgpackr$2f$unpack$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/msgpackr/unpack.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$msgpackr$2f$struct$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/msgpackr/struct.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$msgpackr$2f$stream$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/msgpackr/stream.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$msgpackr$2f$iterators$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/msgpackr/iterators.js [app-route] (ecmascript)");
...
if (!nativeAccelerationDisabled) {
    let extractor;
    try {
        if ("TURBOPACK compile-time truthy", 1) extractor = __turbopack_context__.r("[project]/node_modules/msgpackr-extract/index.js [app-route] (ecmascript)");
        else //TURBOPACK unreachable
        ;
        if (extractor) (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$msgpackr$2f$unpack$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["setExtractor"])(extractor.extractStrings);
    } catch (error) {
...
//# sourceMappingURL=node_modules_msgpackr_534d8930._.js.map