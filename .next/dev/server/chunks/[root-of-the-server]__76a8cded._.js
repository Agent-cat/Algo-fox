...
"[project]/lib/languages.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/points.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const connection = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ioredis$2f$built$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]({
...
"[project]/core/services/submission.service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$languages$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/languages.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$points$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/points.ts [app-route] (ecmascript)");
...
class SubmissionService {
    ...
    static async createSubmission(userId, problemId, judge0Id, code, mode = "SUBMIT", contestId) {
        ...
        const langInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$languages$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getLanguageById"])(judge0Id);
        ...
        if (!language) {
            ...
            const dbLanguage = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].language.findUnique({
                where: {
                    judge0Id: judge0Id
                }
            });
            if (dbLanguage) {
                ...
                try {
                    language = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].language.create({
                        data: {
                            name: languageName,
                            judge0Id: judge0Id
                        }
                    ...
                    if (error.code === 'P2002') {
                        const existingByName = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].language.findUnique({
                            where: {
                                name: languageName
                            }
                        });
                        if (existingByName) {
                            ...
                            const existingByJudge0Id = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].language.findUnique({
                                where: {
                                    judge0Id: judge0Id
                                }
                            });
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].submission.create({
            data: {
                userId,
                problemId,
    ...
    static async updateSubmissionStatus(submissionId, status, time, memory) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].submission.update({
            where: {
                id: submissionId
            },
            data: {
        ...
        try {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["revalidateTag"])(`submission-${submissionId}`, "max");
        } catch (error) {
    ...
    static async createTestCases(submissionId, testCases) {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction(testCases.map((tc)=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].testCase.create({
                data: {
                    submissionId,
                    index: tc.index,
    ...
    static async updateTestCaseResult(judge0TrackingId, status, time, memory, errorMessage, stdout) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].testCase.update({
            where: {
                judge0TrackingId
            },
            data: {
    ...
    static async updateTestCasesBatch(updates) {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction(updates.map((update)=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].testCase.update({
                where: {
    ...
    static async incrementProblemSolved(problemId, userId) {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction(async (tx)=>{
            ...
            if (acceptedCount === 1) {
                ...
                const points = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$points$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getPointsForDifficulty"])(problem.difficulty);
                ...
                try {
                    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].del(`user-score-${userId}`);
                    // Invalidate leaderboard cache so new users appear
                    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].del('leaderboard:global');
                    // Invalidate Next.js cache tags for categories
                    try {
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateTag"])('categories-list');
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateTag"])(`categories-DSA-user-${userId}`);
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateTag"])(`categories-SQL-user-${userId}`);
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateTag"])(`user-submissions-${userId}`);
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateTag"])('problems-list');
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateTag"])('problems-search');
                    } catch (e) {
    ...
    static async getSubmissionById(id) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].submission.findUnique({
            where: {
                id
            },
            include: {
    ...
    static async getProblemSubmissions(problemId, userId, take = 20, cursor) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].submission.findMany(query);
    }
    static async invalidateClassroomTracking(userId) {
        try {
            // Find all classrooms the user is enrolled in where tracking is active
            const classrooms = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].classroom.findMany({
                where: {
                    students: {
                        some: {
                            id: userId
            ...
            if (classrooms.length > 0) {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].del(...keys);
                ...
                classrooms.forEach((c)=>{
                    ...
                    try {
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["revalidateTag"])(`classroom-${c.id}`, "max");
                    } catch (e) {
...
"[project]/core/queues/submission.queue.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$track$2d$dynamic$2d$import$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/build/webpack/loaders/next-flight-loader/track-dynamic-import.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/bullmq/dist/esm/index.js [app-route] (ecmascript) <locals>");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$classes$2f$worker$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/bullmq/dist/esm/classes/worker.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/redis.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$core$2f$services$2f$submission$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/core/services/submission.service.ts [app-route] (ecmascript)");
;
;
;
;
const QUEUE_NAME = "submission-queue";
const submissionQueue = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$classes$2f$queue$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Queue"](QUEUE_NAME, {
    connection: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]
});
...
const worker = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$classes$2f$worker$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Worker"](QUEUE_NAME, async (job)=>{
    ...
    try {
        ...
        const { prisma } = await /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$track$2d$dynamic$2d$import$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["trackDynamicImport"])(__turbopack_context__.A("[project]/lib/prisma.ts [app-route] (ecmascript, async loader)")); // Lazy import to avoid init issues
        ...
        if (testCasesToEvaluate.length === 0) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$core$2f$services$2f$submission$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SubmissionService"].updateSubmissionStatus(submissionId, "ACCEPTED", 0, 0);
            return;
        }
        ...
        if (problem.domain === "SQL") {
            ...
            const { convertBatchToSQLite } = await /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$track$2d$dynamic$2d$import$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["trackDynamicImport"])(__turbopack_context__.A("[project]/lib/sql-converter.ts [app-route] (ecmascript, async loader)"));
        ...
        const judge0Tokens = await __TURBOPACK__imported__module__$5b$project$5d2f$core$2f$services$2f$submission$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SubmissionService"].sendToJudge0(language.judge0Id, codeToExecute, testCasesToEvaluate.map((tc)=>({
                input: tc.input,
                output: tc.output
            })));
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$core$2f$services$2f$submission$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SubmissionService"].createTestCases(submissionId, testCaseRecords);
        ...
        while(!isComplete && Date.now() - START_TIME < MAX_TOTAL_TIME_MS){
            ...
            const batchResults = await __TURBOPACK__imported__module__$5b$project$5d2f$core$2f$services$2f$submission$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SubmissionService"].getBatchResults(pendingTokens);
            ...
            if (updatesToApply.length > 0) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$core$2f$services$2f$submission$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SubmissionService"].updateTestCasesBatch(updatesToApply);
                ...
                if (publishedUpdates.length > 0) {
                    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].publish(`submission:${submissionId}`, JSON.stringify({
                        type: "CASE_UPDATE",
        ...
        if (isComplete) {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$core$2f$services$2f$submission$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SubmissionService"].updateSubmissionStatus(submissionId, finalStatus, avgTime, maxMemory);
            ...
            if (finalStatus === "ACCEPTED" && submission.mode === "SUBMIT") {
                await __TURBOPACK__imported__module__$5b$project$5d2f$core$2f$services$2f$submission$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SubmissionService"].incrementProblemSolved(problem.id, submission.userId);
            }
            // Invalidate Live Tracking Cache
            await __TURBOPACK__imported__module__$5b$project$5d2f$core$2f$services$2f$submission$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SubmissionService"].invalidateClassroomTracking(submission.userId);
        } else {
            await __TURBOPACK__imported__module__$5b$project$5d2f$core$2f$services$2f$submission$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SubmissionService"].updateSubmissionStatus(submissionId, "TIME_LIMIT_EXCEEDED");
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].publish(`submission:${submissionId}`, JSON.stringify({
                type: "COMPLETE",
                data: {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$core$2f$services$2f$submission$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SubmissionService"].updateSubmissionStatus(submissionId, "RUNTIME_ERROR");
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].publish(`submission:${submissionId}`, JSON.stringify({
            type: "COMPLETE",
            data: {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$core$2f$services$2f$submission$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/core/services/submission.service.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$core$2f$queues$2f$submission$2e$queue$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/core/queues/submission.queue.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/prisma.ts [app-route] (ecmascript)"); // Direct access for session check if needed
;
;
;
;
...
async function GET(req) {
    ...
    try {
        const { prisma } = await /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$track$2d$dynamic$2d$import$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["trackDynamicImport"])(__turbopack_context__.A("[project]/lib/prisma.ts [app-route] (ecmascript, async loader)"));
...
async function POST(req) {
    try {
        ...
        if (contestId) {
            const contest = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].contest.findUnique({
                where: {
                    id: contestId
                },
                select: {
            ...
            const participation = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].contestParticipation.findUnique({
                where: {
                    userId_contestId: {
                        userId,
                        contestId
            ...
            if (participation?.isFinished) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: "You have already ended your contest session"
                }, {
                    status: 403
                });
            }
        ...
        const submission = await __TURBOPACK__imported__module__$5b$project$5d2f$core$2f$services$2f$submission$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SubmissionService"].createSubmission(userId, problemId, languageId, code, mode, contestId);
        // Invalidate Tracking Cache so teachers see "Pending" immediately
        await __TURBOPACK__imported__module__$5b$project$5d2f$core$2f$services$2f$submission$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SubmissionService"].invalidateClassroomTracking(userId);
        // 2. Add to Queue
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$core$2f$queues$2f$submission$2e$queue$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addSubmissionJob"])(submission.id);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__76a8cded._.js.map