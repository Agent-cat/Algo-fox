...
const redis = process.env.REDIS_URL && !isRedisDisabled
 ...
 *
 * PERF: Removed verbose console.log on every GET/SET.
 * At 10K RPS with 90% cache hit ratio this was emitting ~18K log lines/sec.
 *
