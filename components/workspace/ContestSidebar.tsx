...
export default function ContestSidebar({ contest, currentProblemId, solvedProblemIds }: ContestSidebarProps) {
    ...
    return (
        <div className="relative flex h-full w-full bg-[#fafafa] dark:bg-[#121212] flex-col overflow-hidden">
            <div className="p-4 border-b border-gray-200 dark:border-[#262626] bg-[#fafafa] dark:bg-[#121212] flex items-center justify-between">
            ...
            <div className="p-4 space-y-4 bg-gray-50 dark:bg-[#111] border-t border-gray-200 dark:border-[#262626]">
                <div>
                    <div className="text-[10px] font-black text-gray-600 dark:text-gray-400 uppercase mb-1 tracking-widest">Contest Progress</div>
