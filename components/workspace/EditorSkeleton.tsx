...
export default function EditorSkeleton() {
  return (
    <div className="w-full h-full bg-white dark:bg-[#1e1e1e] rounded-sm border border-gray-200 dark:border-[#262626] flex flex-col animate-pulse">
      {/* Toolbar */}
      <div className="h-10 border-b border-gray-200 dark:border-[#262626] flex items-center px-4 justify-between bg-[#fafafa] dark:bg-[#262626] shrink-0">
      ...
      {/* Editor Area */}
      <div className="flex-1 p-4 flex gap-4 bg-[#fafafa] dark:bg-[#1e1e1e] overflow-hidden">
        {/* Line Numbers */}
