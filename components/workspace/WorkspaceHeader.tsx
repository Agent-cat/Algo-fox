...
const WorkspaceHeader = memo(({
  ...
  return (
    <motion.div
      ...
      className="h-14 bg-white/40 dark:bg-black/20 backdrop-blur-xl border-b border-gray-200/50 dark:border-white/5 flex items-center justify-between px-4 z-10 relative"
    >
      {/* LEFT: NAVIGATION */}
