...
export default function SubmissionDistribution({ problemId, currentValue, type }: SubmissionDistributionProps) {
        ...
        <div className="space-y-6">
            ...
            <div className="h-24 flex items-end gap-[2px] pt-4">
                {distribution.map((item, idx) => {
                    ...
                    // For runtime, we want to highlight the bucket where our runtime falls.
                    // Since it's rounded, we find the closest match or the range.
