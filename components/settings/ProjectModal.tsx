            ...
            <DialogContent className="sm:max-w-[700px] p-0 bg-white dark:bg-[#1D1E23] border-none shadow-2xl rounded-2xl overflow-hidden">
                <form onSubmit={handleSubmit(onSubmit)}>
                    <DialogHeader className="p-6 pb-4 border-b border-gray-100 dark:border-[#333]">
                        <DialogTitle className="text-center text-xl font-bold text-gray-900 dark:text-gray-100 tracking-wide">Projects</DialogTitle>
                    </DialogHeader>

                    <div className="p-8 max-h-[75vh] overflow-y-auto space-y-6">
                        <div>
                            <input {...register("title")} required className={inputClasses} placeholder="Enter Project Title *" />
                        </div>
                        <div>
                            <input {...register("domain")} required className={inputClasses} placeholder="Enter Project domain *" />
                        </div>
                        ...
                        <div>
                            <label className="flex items-center gap-3 cursor-pointer select-none">
                                <input type="checkbox" {...register("currentlyWorking")} className="w-5 h-5 rounded border-gray-300 text-orange-600 focus:ring-orange-500" />
                                <span className="text-gray-600 dark:text-gray-300">I am currently working on this project</span>
                            </label>
                        </div>
