...
export function VerificationModal({ platform, handle, onClose, onSuccess }: VerificationModalProps) {
    ...
    return (
        ...
        >
            <SheetContent className="sm:max-w-[425px] bg-white dark:bg-[#1D1E23] border-none">
                <div className="flex flex-col items-center text-center p-2 mt-6">
                    ...
                    <SheetHeader>
                        <SheetTitle className="text-xl font-bold text-center">Verify {platform} Profile</SheetTitle>
                        <SheetDescription className="text-center pt-2">
                            Step {step} of 3
                        </SheetDescription>
                    </SheetHeader>
                    ...
                    {step === 1 && (
                        <>
                            ...
                            <SheetFooter className="w-full gap-2 sm:gap-0 mt-6 pt-2 flex flex-col sm:flex-row">
                                <Button
                                    variant="outline"
                                    onClick={onClose}
