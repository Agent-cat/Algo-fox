...
export function CertificatesSettingsClient({ user, readonly = false }: CertificatesSettingsClientProps) {
                        ...
                        <div className="flex items-center gap-4">
                            {certificates.length === 0 && (
                                <label className="flex items-center gap-2 text-sm font-medium text-gray-600 dark:text-gray-400 cursor-pointer">
                                    <input
                                        type="checkbox"
                                        checked={!!details.certificatesNone}
                                        onChange={async (e) => {
