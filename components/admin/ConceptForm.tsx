...
export default function ConceptForm({ onSubmit, submitLabel = "Create Concept", initialData }: ConceptFormProps) {
    ...
    return (
        <div className="bg-white dark:bg-[#24262C] border border-gray-200 dark:border-[#262626] rounded-2xl shadow-sm overflow-hidden p-8">
            <form onSubmit={handleSubmit(onSubmitForm)} className="space-y-6">
                ...
                <div className="space-y-3">
                    ...
                    <div className="border border-gray-200 dark:border-[#333] rounded-xl overflow-hidden shadow-sm">
                        <div className="flex items-center gap-2 px-3 py-2 bg-gray-50/50 dark:bg-[#1D1E23] border-b border-gray-200 dark:border-[#333]">
                             <div className="flex bg-white dark:bg-[#1D1E23] border border-gray-200 dark:border-[#333] rounded-md p-0.5">
                        ...
                        {!descriptionPreview ? (
                            <textarea
                                ...
                                className="w-full px-4 py-3 bg-white dark:bg-[#1D1E23] focus:outline-none transition-all font-mono text-sm leading-relaxed text-gray-900 dark:text-gray-100 placeholder:text-gray-400 dark:placeholder:text-gray-600 resize-none min-h-[400px]"
                            />
                        ) : (
