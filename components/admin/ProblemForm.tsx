...
export default function ProblemForm({ initialData, onSubmit, submitLabel, domain = "DSA", redirectPath, slugPrefix = "/problems/" }: ProblemFormProps) {
    ...
    const handleNext = async (e?: React.MouseEvent<HTMLButtonElement>) => {
        ...
        else if (currentStep === 4 && isDSA) isValid = await trigger(["testCases"]);
        else if (currentStep === 4 && !isDSA && !isAptitude && !isConcept) isValid = await trigger(["testCases"]);
        else isValid = true;
        ...
        <div className="w-full">
            ...
            <form onSubmit={handleSubmit(onSubmitForm)}>
                <div className="max-w-6xl mx-auto px-8">
                    ...
                    {/* ─── STEP 4: Test Cases ─── */}
                    {((isDSA && currentStep === 4) || (!isDSA && currentStep === (isAptitude || isConcept ? 0 : 4))) && (
