                        ...
                        {[1, 2, 3, 4, 5, 6].map((i) => (
                            <div key={i} className="bg-white dark:bg-[#24262C] rounded-2xl border border-gray-200 dark:border-[#262626] p-5 shadow-sm overflow-hidden relative">
                                ...
                                <div className="space-y-3">
                                    <div className="h-4 w-full bg-gray-100 dark:bg-[#1D1E23] animate-pulse rounded"></div>
                                    <div className="h-4 w-2/3 bg-gray-100 dark:bg-[#1D1E23] animate-pulse rounded"></div>
                                </div>
