...
export function StudentContestCard({ contest }: StudentContestCardProps) {
  ...
  return (
    <motion.div
      whileHover={{ y: -2 }}
      className={cn(
        "group flex flex-col md:flex-row items-center gap-6 p-4 md:p-6 transition-all duration-300 relative overflow-hidden rounded-2xl border",
    ...
    >
      ...
      <div className="flex-1 min-w-0 flex flex-col justify-center pl-2 w-full">
        <div className="flex items-center gap-3 mb-2">
          ...
          {/* Visibility Badge */}
          <div className="flex items-center gap-1.5 text-[10px] font-medium uppercase tracking-wider text-gray-500 dark:text-gray-400">
        ...
        {/* Title */}
        <h3 className="text-xl font-medium text-gray-900 dark:text-white truncate pr-4 group-hover:text-orange-500 transition-colors">
          {contest.title}
        </h3>
      ...
      {/* Metadata (Middle) */}
      <div className="flex items-center gap-8 shrink-0 py-4 md:py-0 border-y md:border-y-0 md:border-l border-gray-200 dark:border-[#262626] w-full md:w-auto px-0 md:pl-8 md:pr-4">
        <div className="space-y-1">
          <span className="text-[10px] uppercase font-semibold text-gray-400 tracking-widest block">Starts</span>
        ...
        <div className="space-y-1">
          <span className="text-[10px] uppercase font-semibold text-gray-400 tracking-widest block">Duration</span>
          <div className="flex items-center gap-1.5 text-sm font-medium text-gray-700 dark:text-gray-200">
      ...
      <div className="shrink-0 w-full md:w-56 flex flex-col justify-center gap-2">
        ...
        {isLive ? (
          <Link
            ...
            className="group/btn relative flex items-center justify-center gap-2 w-full py-3 bg-gray-900 dark:bg-white text-white dark:text-black font-semibold uppercase text-[11px] tracking-wider rounded-xl transition-all shadow-md active:scale-[0.98] overflow-hidden"
          >
            ...
            <span className="relative z-10">
              {contest.isParticipating ? "Resume" : "Start"}
            </span>
          </Link>
        ) : isPast ? (
          <Link
