...
export function CreateContestForm({
  ...
  useEffect(() => {
    if (
      institutionId &&
      (visibility === "CLASSROOM" || visibility === "INSTITUTION")
    ) {
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    type="datetime-local"
                    {...register("startTime")}
                    className="w-full px-4 py-2 bg-white dark:bg-[#1a1a1a] border border-gray-300 dark:border-[#333] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all scheme-light] dark:scheme-dark]"
                  />
            ...
            <div className="space-y-4 pt-4 border-t border-gray-100 dark:border-[#262626]">
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                  If set, users must enter this password to join.
                </p>
              </div>
              ...
              <label className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-[#1a1a1a] rounded-lg border border-gray-200 dark:border-[#333] cursor-pointer">
                ...
                <div>
                  ...
                  <span className="text-xs text-gray-500 dark:text-gray-400">
                    Problems will be shown in a different order for each user.
                  </span>
                </div>
              </label>
            </div>
      ...
      <section className="bg-white dark:bg-[#141414] border border-gray-200 dark:border-[#262626] p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
              Search and select problems for this contest
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="space-y-4">
            ...
            <div className="border border-gray-200 dark:border-[#333] overflow-hidden min-h-50 max-h-100 overflow-y-auto">
              {isSearchingProblems ? (
                      ...
                      >
                        ...
                        <button
                          ...
                          className={`p-1.5 transition-all ${
                            isSelected
                              ? "bg-orange-600 text-white"
                              : "bg-gray-100 dark:bg-[#333] text-gray-400 dark:text-gray-500"
                          }`}
                        >
                          <Plus
          ...
          <div className="space-y-4">
            ...
            <div className="border-2 border-dashed border-gray-200 dark:border-[#333] min-h-62.5 p-4">
              {selectedProblems.length > 0 ? (
                <div className="space-y-2">
                  {selectedProblems.map((problem, index) => (
                    <div
                      key={problem.id}
                      className="flex items-center justify-between p-3 bg-gray-50 dark:bg-[#1a1a1a] border border-gray-200 dark:border-[#333]"
                    >
