...
export function UserProfileCard(props: UserProfileCardProps) {
    ...
    return (
        <div className="bg-[#fafafa] dark:bg-[#1D1E23] rounded-3xl border-2 border-dotted border-gray-300 dark:border-white/20 p-6 shadow-sm hover:shadow-lg transition-shadow duration-300">
