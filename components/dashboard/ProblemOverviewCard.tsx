            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 gap-4">
                ...
                <div className="flex items-center gap-4 max-w-full overflow-hidden">
                    <div className="relative flex items-center group max-w-full py-1">
                        ...
                        <div 
                            ref={tabsRef}
                            className="flex bg-gray-100 dark:bg-white/5 p-1.5 rounded-full relative overflow-x-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] whitespace-nowrap max-w-[280px] xs:max-w-[360px] sm:max-w-[440px] md:max-w-[480px] lg:max-w-[480px]"
                        >
...
function BreakdownTooltip({ breakdown, mousePos }: { breakdown: Record<string, number>; mousePos: { x: number; y: number } }) {
    ...
    return (
        ...
        >
            <div className="bg-white/95 dark:bg-white/5/95 text-gray-900 dark:text-white p-3 rounded-xl shadow-2xl border border-gray-200 dark:border-[#333] backdrop-blur-md">
