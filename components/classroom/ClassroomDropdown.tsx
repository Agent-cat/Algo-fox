...
import { School, ChevronDown, BookOpen, User, Plus, ArrowRight, Loader2 } from "lucide-react";
                    ...
                    >
                        <div className="p-2 space-y-1">
                            ...
                            <div className="p-2">
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        <Plus className={`w-4 h-4 transition-transform ${isJoinExpanded ? "rotate-45" : ""}`} />
                                        <span className="text-sm font-bold">Join New Batch</span>
                                    </div>
                                    <ChevronDown className={`w-3 h-3 transition-transform ${isJoinExpanded ? "rotate-180" : ""}`} />
                                </button>
                                ...
                                <AnimatePresence>
                                    {isJoinExpanded && (
                                        ...
                                        >
                                            <form onSubmit={handleJoin} className="p-3 pt-4 space-y-3">
                                                <input
                                                    type="text"
                                                    value={code}
